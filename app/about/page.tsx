          ...
          <div className="container raleway-font p-5">
            <div className="row">
              ...
              <div className="col-md-8">
                ...
                <p className="dark-gray-text ps-5 pb-5">NederLees is a project started by two language-loving friends. Jada and Rick met online while in university and quickly became friends through
            ...
            <div className="row pb-5">
              <div className="col-md-6">
                ...
                <p className="dark-gray-text pe-5">
              ...
              <div className="col-md-6">
                ...
                <p className="dark-gray-text ps-5">
